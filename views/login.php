<section class="" style="background-color: #9A616D;height:100vh;">
            ...
            <div class="card" style="border-radius: 1rem;">
              <div class="row g-0">
                <div class="col-md-6 col-lg-5 d-none d-md-block">
                  <img src="assets/image/bank.jpg"
                    alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem; margin-top: 100px;" />
                </div>
                  ...
                  <div class="card-body p-4 p-lg-5 text-black">
                    ...
                    <form method="" action="">
                      ...
                      <div class="d-flex align-items-center mb-3 pb-1">
                        ...
                        <span class="h1 fw-bold mb-0">Sen Bank yéwi </span>
                      </div>
